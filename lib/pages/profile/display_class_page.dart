// lib/pages/profile/display_class_page.dart
...
class DisplayClassPage extends StatefulWidget {
  const DisplayClassPage({super.key});
  @override
  State<DisplayClassPage> createState() => _DisplayClassPageState();
}

class _DisplayClassPageState extends State<DisplayClassPage> {
  ...
  Future<void> _applyToAll({
    ...
    for (int i = 0; i < snap.docs.length; i += chunk) {
      final part =
          snap.docs.sublist(i, (i + chunk > snap.docs.length) ? snap.docs.length : i + chunk);
          ...
          child: ConstrainedBox(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  // 상단: Back 버튼 (우측 정렬)
                  Row(children: const [Spacer(), _BackButton()]),
                        ...
                        Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextButton(
                                onPressed: () {
                                  // presenter 쪽과 동일하게 TODO 유지
                                  // Navigator.pushNamed(context, '/profile/class/details',
