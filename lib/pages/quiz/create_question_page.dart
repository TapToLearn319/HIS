...
class _CreateQuestionPageState extends State<CreateQuestionPage> {
  ...
  'hubs/${widget.hubId}/quizTopics/${widget.topicId}/quizzes',
      ...
      setState(() {
        _nextQuestionNumber = (snap.docs.length + 1);
      });
    } catch (e) {
      debugPrint('Failed to load question count: $e');
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _sectionTitle('Question', scale),
          SizedBox(height: 8 * scale),
          _questionField(scale),
          SizedBox(height: 24 * scale),
          _answerOptionsTitle(scale),
          SizedBox(height: 8 * scale),
          _optionsCard(scale),
          SizedBox(height: 24 * scale),
  ...
  Widget _answerOptionsTitle(double scale) {
    return Center(
      child: Container(
        width: 948,
  ...
  Widget _sectionTitle(String text, double scale) {
    final prefix =
        _nextQuestionNumber != null && text == 'Question'
            ? '${_nextQuestionNumber!}. '
            : '';
